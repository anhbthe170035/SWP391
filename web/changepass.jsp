<%-- 
    Document   : changepass
    Created on : Aug 24, 2024, 6:59:21 PM
    Author     : HMTheBoy154
--%>
...
<body>
    <div class="col-md-6 offset-md-3">
        ...
        <div class="card card-outline-secondary">
            ...
            <div class="card-body">
                <form class="form" role="form" autocomplete="off" action="changepwd" method="post">
                    <div class="form-group">
                        <label for="inputUsername">Username</label>
                        <input type="text" class="form-control" id="inputUsername" value="${username}" readonly>
                    </div>
                    <h6>${errorchangepass}</h6>
                    <div class="form-group">
                        <label for="inputCurrentPassword">Current Password</label>
                        <input type="password" class="form-control" id="inputCurrentPassword" required="" name="currentpass">
                    </div>
                    <div class="form-group">
